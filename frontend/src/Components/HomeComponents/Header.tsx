    ...
    return(
        ...
        <header className="flex flex-row justify-between shadow-2xl h-[60px] px-5 z-50 items-center w-full bg-[#1B4332] text-white fixed top-0">
            ...
            <nav className="flex flex-row justify-center items-center gap-5 max-[750px]:hidden">
                ...
                <a href="/favoris" style={{
                    fontSize : location.pathname === "/favoris" ? "17px" : "15px",
                    fontWeight : location.pathname === "/favoris" ? "bold" : "500"
                }}>Favoris</a>
            ...
            <div onClick={()=>setShowNav(prev => !prev)} className="hidden max-[750px]:block text-[1.7em] font-bold cursor-pointer transition-opacity duration-200 hover:opacity-70 active:">&#9776;</div>
...
exit={{ x: 250, opacity: 0 }}
      transition={{ duration: 0.3, ease: "easeInOut" }} className="hidden max-[750px]:flex flex-col  h-[calc(100%-60px)] p-5 text-[#1B4332] bg-white gap-3 shadow-2xl z-50 fixed right-0 w-[200px]">
