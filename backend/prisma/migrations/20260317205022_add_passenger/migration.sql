/*
  ...
  - You are about to drop the column `totalPrice` on the `Passenger` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Passenger" DROP COLUMN "totalPrice";
